...
<div class="container">
	<div class="row">
		...
		<h2 style="text-align: center;">Order <?php echo  $orderdetail[0]['ord_key'] ?> Details</h2>
	...
	<div class="wrap-cart">
       ...
       <div class="cart-card">
            <img src="<?php echo base_url(); ?>uploads/gallery/<?php echo $orderdetail[0]['ps_image']; ?>" style="width:50px;height: 50px" alt="card">
            <div class="cart-card-info">
                 <div class="cart-card-name">
                      <p class="h4"><?php echo $orderdetail[0]['product_title']; ?></p>
                      <span><b>Quantity :</b> <?php echo $orderdetail[0]['order_quantity']; ?> </span>

                 </div>
                 <div class="cart-card-price">
                      <p class="once-price">$299.00</p>
                 </div>
                 <div class="">
                      ...
                      <span>Order  Status</span> <?php if($orderdetail[0]['ord_status']==0){ echo "Confirmed" ;}
                       ...
                       ?>
                       <br>
                      <span><b>Orderd On :</b><?php echo date('d-m-Y',strtotime($orderdetail[0]['ord_date'])); ?> </span>

                 </div>

                 <div class="cart-card-quantity">
                  <?php if($orderdetail[0]['ord_status']==0){  ?>
                       <a  class="btn btn-primary order_cancel" data-order_product_id=" <?php echo $orderdetail[0]['order_product_id']; ?>" href="javascript:void(0)">Cancel Order</a>
                  <?php }else{ ?>
