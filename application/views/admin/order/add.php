                            ...
                            <div class="widget-content widget-content-area">
                                <form action="<?php echo base_url(); ?>brand/insert" method="POST">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Color Title (en)*" value="" name="brand_name" >
                                         <span style="color:red;"><?php echo form_error('brand_name'); ?></span>
                                    </div> 
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput1">Brand Title (ar)</label>
                                        <input type="text"  class="form-control arabictxt" placeholder="Enter Color Title (ar)" name="ar_brand_name" value="" >
