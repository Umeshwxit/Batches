   ...
   <div class="col-lg-12 col-lg-12 col-md-12 col-sm-12 col-12  layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <form action="<?php echo base_url(); ?>brand/updates" method="POST">
                                    <input type="hidden" name="id" value="<?php echo $update->brand_id; ?>">
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput1">Brand Title (en)</label>
                                        <input type="text" class="form-control" placeholder="Enter Brand Title (en)*" value="<?php echo $update->brand_name; ?>" name="brand_name" >
                                         <span style="color:red;"><?php echo form_error('brand_name'); ?></span>
                                    </div> 
                                    <!--<div class="form-group mb-4">-->
                                    <!--    <label for="exampleFormControlInput1">Brand Title (ar)</label>-->
                                    <!--    <input type="text"  class="form-control arabictxt" placeholder="Enter Brand Title (ar)" name="ar_brand_name" value="<?php echo $update->ar_brand_name; ?>" style="text-align: right;">-->
