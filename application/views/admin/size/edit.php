   ...
   <div class="col-lg-12 col-lg-12 col-md-12 col-sm-12 col-12  layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <form action="<?php echo base_url(); ?>size/updates" method="POST">
                                  <input type="hidden" name="id" value="<?php echo $update->size_id; ?>">
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput1">Category</label><select class="form-control" id="cat_name" name="cat_name">
                                             <option value="">Select Category</option>
                                         <?php foreach($list as $d){ ?>
                                        <option <?php if($update->size_cat_id==$d->category_id){ ?> selected="selected" <?php } ?> value="<?php echo $d->category_id; ?>"><?php echo $d->category_name; ?></option>
                                        <?php } ?>
                                         </select>
                                    ...
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput1">Sub Category</label>
                                         <select name="subcat_name" id="subcat_name" class="form-control input2" required>
                                          <option value="<?php echo  $update->size_subcat_id; ?>"><?php   
                                           $size_subcat_id=$update->size_subcat_id;
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Name" name="size_name" value="<?php echo $update->size_name; ?>">
                                    ...
                                    <!--    <input type="text" class="form-control arabictxt" placeholder="Size Title ar" name="ar_size_name" value="<?php echo $update->ar_size_name; ?>"  style="text-align: right;">-->
