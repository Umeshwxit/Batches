   ...
   <div class="col-lg-12 col-lg-12 col-md-12 col-sm-12 col-12  layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <form action="<?php echo base_url(); ?>page/updates" method="POST">
                                	<input type="hidden" name="id" value="<?php echo $update->page_id; ?>">
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput1">Page Title (en)</label>
                                        <input type="text" class="form-control" placeholder="Enter Page Title (en)*" value="<?php echo $update->page_name; ?>" name="page_name" >
                                         <span style="color:red;"><?php echo form_error('page_name'); ?></span>
                                    </div> 
                                    <!--<div class="form-group mb-4">-->
                                    <!--    <label for="exampleFormControlInput1">Page Title (ar)</label>-->
                                    <!--    <input type="text"  class="form-control arabictxt" placeholder="Enter Page Title (ar)" name="page_name_ar" value="<?php echo $update->page_name_ar; ?>"  style="text-align: right;">-->
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="page_disc"><?php echo $update->page_disc; ?></textarea>
                                         <span style="color:red;"><?php echo form_error('page_disc'); ?></span>
                                    </div>  
                                    <!--   <div class="form-group mb-4">-->
                                    <!--    <label for="exampleFormControlInput1">Description (ar)</label><br>-->
                                    <!--    <textarea rows="20" cols="100"  name="page_disc_ar"  style="text-align: right;"><?php echo $update->page_disc_ar; ?></textarea>-->
